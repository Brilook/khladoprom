...
<body>
  ...
  <!-- <div class="content" style="width: 1024px; height: 1948px;">
    ...
    <a href="prodnew.php">
      <div class="brand" style="float: left; margin-left: 120px;">
        <p class="brandtext">ТМ ХЛАДИК</p>
      </div>
    </a>
    <a href="brand.php">
      <div class="brand" style="float: right; margin-right: 10px;">
        <p class="brandtext">НАШИ БРЕНДЫ</p>
      </div>
    </a>
    <div style="float: left; width:648px; height:41px; margin-top: 40px; margin-left: 122px;"><img
        src="images/prodtitbg.gif" width="628" height="41" /></div>
    <div class="prodcontent" style="clear: both;"><img src="images/prodphoto01.jpg" width="991" height="449" /></div>
