  ...
  <div class="header">
    ...
    <div class="topline4">
      <div class="topline4in">
        ...
        <div class="mainmenuitem">
          <p class="mainmenuitemtext" style="margin-left: 24px;">Качество</p>
        </div>
        </a> <a href="produce.php">
        <div class="mainmenuitem">
          <p class="mainmenuitemtext" style="margin-left: 26px;">Продукция</p>
        </div>
        </a> <a href="manufacture.php">
        <div class="mainmenuitem">
          <p class="mainmenuitemtext" style="margin-left: 28px;">Производство</p>
        </div>
        </a> <a href="label.php">
        <div class="mainmenuitem">
        ...
        <div class="mainmenuitem">
          <p class="mainmenuitemtext" style="margin-left: 24px;">Контакты</p>
        </div>
        </a> </div>
    </div>
  </div>
...
<div class="content" style="width: 1024px; height: 654px;";>
  <div class="title">
    <p class="titletext">О КОМПАНИИ</p>
  </div>
    <p class="contenttext" style="margin-top: 26px; line-height: 1.3;">
Совсем скоро харьковское мороженое отпразднует свой 90-летний юбилей. И уже почти 25 лет ООО &laquo;Хладопром&raquo; продолжает харьковскую историю, даря своим покупателям радость, счастье и удовольствие от встеречи с самым вкусным десертом в мире - мороженым. Многолетний опыт и современное оборудование от ведущих производителей, таких как Tetra Pak, Gram, Ice Group, гарантируют высокое качество нашего мороженого. Производственные мощности позволяют ООО &raquo;Хладопром&raquo; производить более 100 тонн мороженого в сутки. А своевременная и бесперебойная доставка продукции по территории Украины никого не оставит без любимого лакомства.
    </p>
