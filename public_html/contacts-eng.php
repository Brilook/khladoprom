...
<head>
  ...
  <title>Khladoprom - Constact</title>
    ...
    <div class="container">
      <div class="contacts">
        <h1 class="about-title ">
          KHLADOPROM ICE CREAM FACTORY</h1><br />
        <div class="contacts-logo">
          <img src="images/map.png">
        </div>
        <p class="item-text">
          61099, Kharkiv, Ukraine,<br />
          Khabarova St., 1</p><br />
        <a class="tel" href="tel:+38 (057) 754 44 40">tel.: +38 (057) 754 44 40</a>
        <p class="tel">fax: (057) 754 44 30<br /></p>
